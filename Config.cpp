...
const std::string Config::MENU_GAME = "Start";
...
const std::string Config::MENU_SETTING_BUTTON = "Save";
 ...
 const unsigned Config::MENU_GAME_SIZE_SCORE = 50;

 const int Config::MENU_GAME_SCORE1_POSITION_X = 862;
 const int Config::MENU_GAME_SCORE1_POSITION_Y = 0;
 const int Config::MENU_GAME_SCORE2_POSITION_X = 712;
 const int Config::MENU_GAME_SCORE2_POSITION_Y = 0;
